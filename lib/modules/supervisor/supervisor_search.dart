...
class supervisorSearchScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<supervisorLayoutcubit,supervisorLayoutstates>(
      ...
      builder: (context, state) {
       var cubit=supervisorLayoutcubit.get(context).search;
        return Scaffold(
          body: Container(
            color: defaultcol,
            child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            IconButton(
                              onPressed: () {
                                supervisorLayoutcubit.get(context).search = [];
                        ...
                        TextFormField(
                          ...
                          onChanged: (value) {
                            supervisorLayoutcubit.get(context).superSearch(searchcon.text);
                          },
  ...
  return   SingleChildScrollView(
      child: Column(
        ...
        children: [
          InkWell(
          onTap: () async {
  await supervisorLayoutcubit.get( context).supervisorGetCase(model.caseId as String);
